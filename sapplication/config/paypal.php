 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'handytrail.pay-facilitator_api1.gmail.com' : 'handytrail.pay_api1.gmail.com';
$config['APIPassword'] = $config['Sandbox'] ? '1379040671' : 'BXG4DJBY2BC33BSU';
$config['APISignature'] = $config['Sandbox'] ? 'AUevAeFKZ6t4T9WusdFuB4MQkjVVAH-SMyGBQpSDLMuUJa8OWKs6deoT' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31A.Fs99ZjHVttLZ9Qv8uwTe2rVG-T';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'tourist@ideavietnam.com ' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['PayFlowPassword'] = $config['Sandbox'] ? '12345678' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'dev@ideavietnam.com' : 'PRODUCTION_VENDOR_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = $config['Sandbox'] ? 'handytrail.pay@gmail.com' : 'PRODUCTION_DEV_EMAIL_GOES_HERE';
