 ...
 function translate($sl, $tl, $q)
 {
	 ...
	 $url = "https://translate.google.com/translate_a/single?client=gtx&sl=".$sl."&tl=".$tl."&hl=".$tl."&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&dt=at&ie=UTF-8&oe=UTF-8&otf=2&ssel=0&tsel=0&kc=1&tk=". $tk ."&q=" . $q;
	 return $url;
 }
