...
class MY_Controller extends MX_Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->postData = trimArray($postData['data'][strtolower($this->controller)]);
        ...
        $this->pagingConfig['base_url'] = $this->module . '/' . $this->controller . '/getList';
...
//			 debug($module);
        ...
        $script = "<script defer  type=\"text/javascript\" src=\"" . BASE_URL.'cache/'.$module.'/'.$this->lang->lang().'/'.$jsFile. "\"></script>";
     ...
     * @param string $module
     */
    public function loadJs($jsFile,$flag = false)
    {

        $script = "<script defer type=\"text/javascript\" src=\"" . SCRIPTS_PATH .  $jsFile . "\"></script>";
        if(!$flag){
...
//			echo $this->model->db->last_query();
    ...
    protected function getList($start = '')
    {
        ...
        if (isset($this->postData['numberListShowing'])) {
