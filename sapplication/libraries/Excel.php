<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Excel  
    {
        ...
        function Excel()
        {
            require_once(EXCEL_BASE.'PHPExcel.php');
            require_once(EXCEL_BASE.'PHPExcel/Writer/Excel5.php');
            require_once(EXCEL_BASE.'PHPExcel/Writer/Excel5/Worksheet.php');
            require_once(EXCEL_BASE.'PHPExcel/IOFactory.php');
