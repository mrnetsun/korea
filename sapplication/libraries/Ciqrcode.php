...
{
	var $cacheable = true;
	var $cachedir = 'uploads/qrcode/cache/';
	var $errorlog = 'uploads/qrcode/logs/';
	var $quality = true;
	var $size = 1024;
	
	function __construct($config = array()) {
		$this->initialize($config);
		if(!$this->cachedir) $this->cachedir = APPPATH.'/cache/';
		if(!$this->errorlog) $this->$errorlog = APPPATH.'/logs/';
	}
