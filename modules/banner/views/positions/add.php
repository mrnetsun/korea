<?php 
	...
	echo $formBase->create('banner/position/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
			...
			<?php echo $formBase->number('number',array('label'=>"LBL_NUMBER_BANNER",'value'=>1,'rules'=>""))?>
