...
<div class="section">
<?php echo $formBase->create('banner/banner/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('title',array('placeholder'=>"LBL_TITLE",'class'=>"span2"))?>
				<?php echo $formBase->input('start_date',array('placeholder'=>"LBL_START_DATE",'class'=>"span2"))?>
				<?php echo $formBase->input('end_date',array('placeholder'=>"LBL_END_DATE",'class'=>"span2"))?>
