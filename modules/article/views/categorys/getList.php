<?php
 //localTime
 //img_status($item->status,site_url('article/category/dataSwitch/'.$item->cateId.'/status'));

$formBase = new FormBase();
echo $formBase->create('article/category/saveAll');
            ...
            <?php if(!empty($aryData)){
            	...
            	foreach ($aryData as $item){            		
					...
					<td class="tl">
						...
						<td class="tc">
							<div><?php echo img_status($item->status,site_url('article/category/dataSwitch/'.$item->cateId.'/status'))?></div>
						</td>
						<td class="tc">
                    	...
                    	<div class="toolbar-icons" >
                            <?php echo ajax_link('article/category/detail/'.$item->cateId,'<i class="action-icon-eye-open"></i>',array('overlay'=>'LBL_VIEW'));?>
                            <?php echo ajax_link('article/category/edit/'.$item->cateId,'<i class="action-icon-edit"></i>',array('overlay'=>'LBL_EDIT'));?>
                            <?php echo ajax_link('article/category/delete/'.$item->cateId,'<i class="action-icon-trash"></i>',array('callBack'=>'reload'));?>
