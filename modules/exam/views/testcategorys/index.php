...
<div class="section">
<?php echo $formBase->create('exam/testcategory/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('cate_name',array('placeholder'=>"LBL_NAME",'class'=>"span2"))?>
				...
				echo $formBase->dropdown('parent_id',array('options'=>$options,'empty'=>'LBL_ALL_CATEGORY','class'=>"span2"))?>
