...
<div id="examHeader">
    ...
    <div class="row examHeader">
        ...
        <div class="col-md-1">
            ...
            <button data-url="<?php echo site_url('luyen-thi/finish/'.$exam_status['_id']->{'$id'})?>" id="btnFinish" class="btn btn-success">Nộp bài</button>
            </div>
        </div>
    </div>
    </div>
...
$(document).ready(function(){
    ...
    $('.answerWrap input').click(function(){
        ...
        $.ajax({
            url: '<?php echo site_url("luyen-thi/updateQuestion")?>',
            type: "POST",
