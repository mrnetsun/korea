...
<div class="row">
    ...
    <div class="col-md-7">
        ...
        if( $anserSheet['exam']['show_member_choise']){?>
        <div class="answerSheetMember">
                    ...
                    if($c['questions'])foreach($c['questions'] as $q){
                        if($q['question_type'] != 11){
                            ...
                            if($q['sub_questions'])foreach($q['sub_questions'] as $sub){
                                ...
                                echo '<span href="#question_'.$sub['question_id'].'"  class="item qIndex_'.$sub['question_id'].'" data-question="'.$sub['question_id'].'"><span class="index">'.$qIndex.'</span>'.$option.'</span> ';
                            }
                        }
            ...
            <?php echo anchor('luyen-thi/chitiet/'.$anserSheet['_id']->{'$id'},'Xem chi tiết',array('style'=>'color:#555'))?>
