...
//                    echo $q['question_type'] ;
                        if($q['question_type'] != 11){
                            ...
                            echo displayQuestionAnswerFront($q,array('member'=>true,'show_checkAnswer'=>1,'exam'=>$exam));
                            ...
                            if($q['sub_questions'])foreach($q['sub_questions'] as $js=>$sub){
                                ...
                                echo displayQuestionAnswerFront($sub,array('member'=>true,'show_checkAnswer'=>1,'exam'=>$exam));
