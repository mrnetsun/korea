...
<?php echo anchor('thi-thu/thi/'.$exam->exam_id,'<i class="fa fa-arrow-circle-right"></i> Vào thi',array('class'=>'btn btn-primary btn-large'))?>
            ...
            if($myHistory){
                foreach($myHistory as $my){
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2"><?php echo anchor('thi-thu/ketqua/'.$my['_id']->{'$id'},'<i class="fa fa-eye"></i> Xem')?></div>
                    </div>
