...
echo page_backgroup('<div class="text-center"><p><br></p><h2>'.__('TITLE_ADD_COMPANY').'</h2>
...
echo $formBase->create('home/company/insert');
?>
...
//                $geo = IP2Geo('42.114.154.95');  $latLong = $geo['lat'].','.$geo['long'];
        ...
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <?php echo $formBase->json('Company_Tel',array('rules'=>'required','config'=>'["LBL_COMPANY_TELEPHONE"]','default'=>2,'max_item'=>3,'class'=>'form-control'));?>
            </div>
            <div class="form-group">
        ...
        <div class="row row-wrap">
            <div class="col-md-12">
                ...
                <?php echo $formBase->submit('submit',array('label'=>'LBL_REGISTER','class'=>'btn btn-primary btn-large')); ?>
                </div>
            </div>
        </div>
    </div>
