	...
	<div class="shell">
		<div id="nav-toolbar">
			<div class="toolbar_header"><h3>
					<span class="sub"><?php echo __('LBL_RUN_FULL_UPDATE') ?></span>
				</h3></div>
			<div class="clr"></div>
		</div>
		<div class="clr"></div>
...
<div class="main">
	<div class="shell system_alert" style="padding: 0px 0px;display: block;">
		<div class="main form-horizontal">
			...
			echo $formBase->create('home/cronlog/command/restart',array('ajax'=>array('Callback'=>'ajaxCallback'),'class'=>'form-horizontal','id'=>'form-cronlog' ));
			?>
