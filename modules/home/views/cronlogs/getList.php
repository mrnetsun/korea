<?php
 //localTime
 //img_status($item->status,site_url('home/cronlog/dataSwitch/'.$item->cronId.'/status'));

$formBase = new FormBase();
echo $formBase->create('home/cronlog/saveAll');
		...
		<thead><!-- universal table heading -->
			<tr>
				...
				<th class="tl w100">
					...
					<th class="tl">
                    	<div class="sortable <?php echo ($sort_key =='description')?$sort_dir:'';?>" onclick="Common.sort(this,'description')"><?php echo __("LBL_DESCRIPTION");?></div>                    	
                    </th>                    
					<th class="tl span2">
            ...
            <?php if(!empty($aryData)){
            	...
            	foreach ($aryData as $item){            		
                    ...
                    <td class="tc first">
                    	<?php echo $formBase->checkbox('cid[]',array('value'=>$item->cronId,'onclick'=>"Common.isCheckAll(this)"));?>
                    </td>

						<td class="tl">
							<div><span class="label label-<?php echo $aryLogType[$item->type]?>"><?php echo __($aryLogType[$item->type])?></span></div>
						</td>
