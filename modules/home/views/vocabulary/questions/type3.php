...
<h2 style="padding: 5px 10px;"><?php echo $question['meaning'];?></h2>
    <div class="answerWrap">
        ...
        foreach($question['answer'] as $j=>$answer){
            ...
            <div><label><span class="control"><input type="radio" name="answer_'.$k.'" value="'.$j.'"/></span><a class="option '.$answer_select.' '.$cStatus.'">'.($j+1).'</a>
            <a class="btnSound soundEffect"  data-audio="'.$answer['audio'].'"><i class="fa fa-volume-up"></i></a>
            </label>
