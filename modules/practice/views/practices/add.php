<?php 
	...
	echo $formBase->create('practice/practice/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
			...
			<?php echo $formBase->input('title',array('label'=>"LBL_WORD",'rules'=>"required",'class'=>"span4"))?>
				...
				<?php echo $formBase->input('slow_audio',array('label'=>"LBL_SLOW_AUDIO",'id'=>'slow_audio_url','unit'=>'<button type="button" class="btn btn-small" onclick="openKCFinder_audio(\'#slow_audio_url\')">Audio</button> <i class="pointer playSound fa fa-volume-up"></i>','rules'=>"",'class'=>"span4"))?>
		            <?php echo $formBase->upload_image('image',array('label'=>"LBL_IMAGE",'rules'=>"",'class'=>"btn"))?>
			<?php echo $formBase->texteditor('detail',array('label'=>"LBL_DETAIL",'rules'=>"",'class'=>"span4 h100"))?>
