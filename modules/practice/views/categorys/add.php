<?php 
	...
	echo $formBase->create('practice/category/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
				...
				echo $formBase->select('parent_id',array('label'=>"LBL_ROOT", 'options'=>$parentOptions,'rules'=>"required",'class'=>"span4"))?>
