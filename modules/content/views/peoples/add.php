<?php 
	...
	echo $formBase->create('content/people/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
					...
					<?php echo $formBase->status('status',array('label'=>"LBL_STATUS",'rules'=>"",'checked'=>ACTIVE))?>
