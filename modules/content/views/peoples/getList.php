<?php
 //localTime
 //img_status($item->status,site_url('content/people/dataSwitch/'.$item->id.'/status'));

$formBase = new FormBase();
echo $formBase->create('content/people/saveAll');
            ...
            <?php if(!empty($aryData)){
            	...
            	foreach ($aryData as $item){            		
					...
					<td class="tl">
				     ...
				     <td class="tl">
						 <div class="span1"><?php echo json_img($item->image)?></div>
						 <div class="span4">
					...
					<td class="tc">
                    	<div><?php echo img_status($item->status,site_url('content/people/dataSwitch/'.$item->id.'/status'))?></div>
                    </td>                    
					<td class="tc">
                    ...
                    <td class="tc last ">
                    	...
                    	<div class="toolbar-icons">
                            <?php echo ajax_link('content/people/detail/'.$item->id,'<i class="action-icon-eye-open"></i>',array('overlay'=>'LBL_VIEW'));?>
                            <?php echo ajax_link('content/people/edit/'.$item->id,'<i class="action-icon-edit"></i>',array('overlay'=>'LBL_EDIT'));?>
                            <?php echo ajax_link('content/people/delete/'.$item->id,'<i class="action-icon-trash"></i>',array('callBack'=>'reload'));?>
