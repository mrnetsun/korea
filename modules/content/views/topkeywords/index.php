...
<div class="section">
<?php echo $formBase->create('content/topkeyword/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('keyword',array('placeholder'=>"LBL_KEYWORD",'class'=>"span2"))?>
