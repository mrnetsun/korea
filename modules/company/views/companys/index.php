...
<div class="row">
    <div class="col-md-8">
        <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="logoBox">
                            <div class="company_logo inline">
                                <?php echo base_img($company->Company_Logo);?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <ul class="list-group list-unstyled list-horizontal contact-company">
                    <li>
                        <i class="fa fa-taxi round box-icon-border"></i> <span class="lb"><?php echo __("LBL_DIRECT")?></span><span class="inner">Chỉ đường</span>
                    </li>
                    ...
                    <li class="Email"><i class="fa fa-envelope round box-icon-border"></i> <span class="lb"><?php echo __("LBL_EMAIL");?></span> <span class="inner"><?php echo $company->Contact->Email?></span></li>
                    <?php }?>
        ...
        <div class="row">
            <?php
            if(!empty($company->Get_In_Touch[0]) || ($company->MST || $company->Establish || $company->Company_Size)){ $col =8; }else{ $col = 12; }
            ?>
...
//                    $company->Brochure = 'xyz/abc.pdf';
        ...
        <?php if(!empty($company->Product_Serivces)){?>
            <div class="row">
                <div class="col-md-12 ">
            ...
            <div class="row">
                        ...
                        foreach($company->Product_Serivces as $group){
                            ...
                            foreach($group->items as $word){
                                echo '<div class="col-md-6">'.anchor('san-pham/'.to_slug($word),$word,array('class'=>'')).'</div>';
                            }
                        }
                        ?>
    ...
    <div class="col-md-4">
        ...
        //            echo "$company->Lat,$company->Long,$company->Company_Name";
            ...
            <div class="sidebar-widget">
                ...
                echo $formBase->create('company/company/sendMail/',array('id'=>'formEnquiry','ajax'=>array('Callback'=>'companyController.cbEnquire')));
                $formBase->fillData($formEmail);
                echo $formBase->hidden('company_id',array('value'=>$company->id));
                ?>
                <div class="">Gửi yêu cầu tới doanh nghiệp này</div>
