<?php
	...
	echo $formBase->create('company/category/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
				...
				?>
			   <?php echo $formBase->dropdown('parentId',array('label'=>"LBL_PARENT",'options'=>$parentOptions,'selected'=>$last_category,'empty'=>__("LBL_ROOT"),'rules'=>"",'class'=>"span4"))?>
