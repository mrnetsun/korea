...
class Partner extends Member_Controller {
	/**
	 * Model
	 * @var string
	 */
	public $model_name  = 'partner_model';
	/**
	 * 
	 * @var Partner_Model
	 */
	...
	*/
    protected function _buildCondition(){
    	...
    	if(!empty($this->postData)){
			...
			if($this->postData['partnerName']!=''){
    		 	$aryCondition['like'][] =  array("mt.partnerName"=>$this->postData['partnerName']);
    		 }			
