<?php 
	...
	echo $formBase->create('system/roles/update',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));
...
?>
    <div class="screenView span7">
        ...
        <div class="section ">            
				...
				<?php echo $formBase->status('status',array('label'=>'Status'))?>
		
		<div class="form-actions ">			
				<?php echo $formBase->submit('BTN_SUBMIT')?>
				<?php echo $formBase->close('BTN_CLOSE')?>
		</div>
