...
<div class="section">
<?php echo $formBase->create('system/department/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('departmentName',array('placeholder'=>"Name",'class'=>"span2"))?>
