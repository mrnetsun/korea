<?php 
	...
	echo $formBase->create('system/resource/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
			...
			<?php echo $formBase->checkbox('permissions',array('label'=>'LBL_ACTION',
				'options'=>array('full'=>'Full','listview'=>'List/view','add'=>'Add','edit'=>'Edit','delete'=>'Delete'),
				'checked'=>array('full','listview','add','edit','delete')
				))?>
