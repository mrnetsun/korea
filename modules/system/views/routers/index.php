...
<div class="section">
<?php echo $formBase->create('system/router/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('slug',array('placeholder'=>"LBL_ALIAS",'class'=>"span2"))?>
