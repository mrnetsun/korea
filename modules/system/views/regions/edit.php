<?php 
	...
	echo $formBase->create('system/region/update',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));
	$formBase->fillData($fillData);
	echo $formBase->hidden('region_id');
?>
    <div class="screenView span7">
		...
		<div class="form-actions ">			
				<?php echo $formBase->submit('BTN_SUBMIT',array('label'=>'Update'))?>
