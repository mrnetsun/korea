<?php 
	...
	echo $formBase->create('member/client/insert',array('ajax'=>_getBaseName('List'),'class'=>'form-horizontal'));?>
    <div class="screenView span7">
		...
		<div class="section ">
				...
				<?php echo $formBase->texteditor('note',array('label'=>"LBL_DETAIL",'checked'=>ACTIVE,'class'=>"span4"))?>
