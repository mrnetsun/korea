...
// List view config
$config['course_viewdefs'] = array(
	
		//action index			
		'index'=>array(
				'title'=>'Course Management', //screen title
				'noModuleTitle'=>0,
				'noToolbar'=>0,
				...
				'items'=>array(
						...
						array(
							'action'=>'course/edit',
							'task'=>'toolbar_icon toolbar_icon-32-edit',
							'label'=>'LBL_EDIT'
						),
						array(
								'task'=>"delete",
	...
	'add'=>array(
		'title'=>'title_add_course', //screen title
		'items'=>array(
			array(
				'link'=>site_url('course/add'),
				'class'=>'toolbar_icon toolbar_icon-32-add',
				'label'=>'LBL_ADD_NEW'
			),
			array(
				'link'=>site_url('course/course'),
				'task'=>'back',
				'label'=>'LBL_BACK'
			),
	...
	'edit'=>array(
		'title'=>'title_edit_course', //screen title
		'items'=>array(
			array(
				'link'=>site_url('course/course'),
				'task'=>'back',
	...
	'detail'=>array(
		'title'=>'title_detail_course', //screen title
		'items'=>array(
			array(
				'link'=>site_url('course/course'),
				'task'=>'back',
