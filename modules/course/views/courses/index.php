...
<div class="section">
<?php echo $formBase->create('course/course/getList',array('ajax'=>_getBaseName('List'),'class'=>'form-inline'));?>
	<input type="hidden" name="search" value="1" />
			<?php echo $formBase->input('title',array('placeholder'=>"LBL_TITLE",'class'=>"span2"))?>
				<?php echo $formBase->input('cate_id',array('placeholder'=>"LBL_CATEGORY",'class'=>"span2"))?>
				<?php echo $formBase->input('mentor',array('placeholder'=>"LBL_MENTOR",'class'=>"span2"))?>
