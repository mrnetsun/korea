...
FormValidate.prototype = {
    ...
    */
	 ...
	 bindEventRules:function(formName, callback){
		...
		this.messages = [];
		this.messages['required'] = '<?php echo __("This field is required.") ?>';
		this.messages['required_trim'] = '<?php echo __("This field is required.") ?>';
		this.messages['matches'] = '<?php echo __("The %s field does not match the %s field.") ?>';
		this.messages['matches_different'] = '<?php echo  __("The %s field must be different the %s field." ) ?>';
		this.messages['valid_email'] = '<?php echo __("Invalid email address.") ?>';
		this.messages['valid_emails'] = '<?php echo __("The %s field must contain all valid email addresses.") ?>';
		this.messages['min_length'] = '<?php echo __("The %s field must be at least %s characters in length.") ?>';
		this.messages['max_length'] = '<?php echo __("The %s field must not exceed %s characters in length.") ?>';
		this.messages['exact_length'] = '<?php echo __("The %s field must be exactly %s characters in length.") ?>';
		this.messages['greater_than'] = '<?php echo __("The %s field must contain a number greater than %s.") ?>';
		this.messages['less_than'] = '<?php echo __("The %s field must contain a number less than %s.") ?>';
		this.messages['greater_date_than'] = '<?php echo __("The %s field must contain a date greater than %s.") ?>';
		this.messages['less_date_than'] = '<?php echo __("The %s field must contain a date less than %s.") ?>';
		this.messages['alpha'] = '<?php echo __("The %s field must only contain alphabetical characters.") ?>';
		this.messages['alpha_numeric'] = '<?php echo __("The %s field must only contain alpha-numeric characters.") ?>';
		this.messages['alpha_dash'] = '<?php echo __("The %s field must only contain alpha-numeric characters; underscores; and dashes.") ?>';
		this.messages['numeric'] = '<?php echo __("This field must contain only numbers.") ?>';
		this.messages['integer'] = '<?php echo __("The %s field must contain an integer.") ?>';
		this.messages['decimal'] = '<?php echo __("The %s field must contain a decimal number.") ?>';
		this.messages['is_natural'] = '<?php echo __("The %s field must contain only positive numbers.") ?>';
		this.messages['is_natural_no_zero'] = '<?php echo __("The %s field must contain a number greater than zero.") ?>';
		this.messages['valid_ip'] = '<?php echo __("The %s field must contain a valid IP.") ?>';
		this.messages['valid_base64'] = '<?php echo __("The %s field must contain a base64 string.") ?>';
		this.messages['min_check'] = '<?php echo __("You must choose at least %s options.") ?>';
		this.messages['max_check'] = '<?php echo __("You may only select a maximum of %s options") ?>';
		this.messages['url'] = '<?php echo __("The %s field must contain Website url") ?>';
		this.messages['float'] = '<?php echo __("The %s field must contain Float number") ?>';
		this.messages['valid_slot'] = '<?php echo __("The %s field invalid format")?>';
        this.messages['valid_name'] = '<?php echo __("The %s field  must not contain white space or special character")?>';
		this.messages['no_space'] = '<?php echo __("The %s whitespace is not allowed")?>';
		this.messages['password_special'] = '<?php echo __("The %s field must only contain special characters,lowercases and numbers")?>';
		this.messages['alpha_space'] = '<?php echo __("The %s field must only contain alphabetical characters")?>';
		this.messages['isnull_or_white_space'] = '<?php echo __("The field is required.")?>';
		this.messages['unlike'] = '<?php echo __("This field must unlike with other field")?>';
		this.messages['valid_image'] = '<?php echo __("The %s field containing jpeg|png|gif|bmp")?>';

		this.messages['no_comma'] = '<?php echo __("The %s field must contain at least 2 words.")?>';
		this.messages['no_special_character'] = '<?php echo __("The %s field must be not contain special character.")?>';

		this.messages['valid_image'] = '<?php echo __("The %s field containing jpeg|png|gif|bmp")?>';
		this.messages['min_unit'] = '<?php echo __("The Similar type must contain at least 2 word or phrase.")?>';
		this.messages['unlike_group'] = '<?php echo __("This options must unlike with one of other field.")?>';
		this.messages['txt_file'] = '<?php echo __("This file type must be .txt file.")?>';
		this.messages['no_special_ex_slash'] = '<?php echo __("This word is invalid.")?>';
		 this.messages['phone_number'] ='<?php echo __("Invalid phone number")?>';
        ...
        for (var i = 0; i < ruleLength; i++) {
            ...
            if (typeof this._hooks[method] === 'function') {
                ...
                if (typeof FormValidateCallBack[method] === 'function') {
        			...
        			Common.alert(method+' <?php echo __("function is not defined!")?>');
        		}
            }
