        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    ...
                    return '<span>'+this.allSelectedText + '</span> <b class="caret"></b>';
                }
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search fa fa-search"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
                filterClearBtn: '<span class="input-group-btn"><button class="btn btn-default multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle fa fa-times"></i></button></span>',
